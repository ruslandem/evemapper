  ...
  $.fn.signaturesTable = function (options) {
      ...
      navigator.clipboard.readText().then(function (text) {
        ...
        $.post({
          ...
          data: {
            ...
            text: text,
            replace: (_options$replace = options.replace) !== null && _options$replace !== void 0 ? _options$replace : false
          }
        }).done(function (response) {
          if (response) {
            var _response$updated, _response$created;
            Toastify({
              text: "".concat((_response$updated = response.updated) !== null && _response$updated !== void 0 ? _response$updated : 0, " added and ").concat((_response$created = response.created) !== null && _response$created !== void 0 ? _response$created : 0, " updated signatures"),
              duration: 3000
            }).showToast();
            _this.show();
          }
    ...
    this["delete"] = function (options) {
      $.post({
        ...
        if (response) {
          Toastify({
            text: "Deleted signature ".concat(options.id),
            duration: 3000
          }).showToast();
          _this.show();
        }
    ...
    var populate = function populate(data) {
      ...
      data.forEach(function (element) {
        var createdTime = window.hdate.prettyPrint(element.created_at, {
          showTime: true
        });

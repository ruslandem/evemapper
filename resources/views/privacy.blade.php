...
@section('content')
    <div class="container main-content">
        ...
        <div class="content p-6 is-darker scrolling">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                        &quot;Us&quot;
                        or
                        &quot;Our&quot; in this Agreement) refers to EveMapper.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to EveMapper, accessible from <a
                            href="https://evemapper.this-server.com" rel="external nofollow noopener"
                            target="_blank">https://evemapper.this-server.com</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By visiting this page on our website: <a href="https://evemapper.this-server.com/contact"
                        rel="external nofollow noopener" target="_blank">https://evemapper.this-server.com/contact</a></li>
            </ul>
        </div>
    </div>
